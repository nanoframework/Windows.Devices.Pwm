...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/Windows.Devices.Pwm/$env:MyNuGetVersion"
    ...
    {
        $commitMessage = "Update Windows.Devices.Pwm version to $env:MyNuGetVersion"
